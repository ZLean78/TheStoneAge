...
func _on_Area2D_body_entered(body):
	...
	if ("Spear" in body.name || "Stone" in body.name) && (body.owner_name=="Citizen" || body.owner_name=="Warrior" || body.owner_name=="General"):
		body_entered=body
...
func _on_EnemyFort_mouse_entered():
	mouse_entered=true
	tree._on_Game5_is_sword()
	tree.touching_enemy=self


func _on_EnemyFort_mouse_exited():
	mouse_entered=false
