...
onready var sheltered_label = $UI/Base/ShelteredLabel
...
func _process(_delta):
	...
	#Actualizar la etiqueta sheltered_label, de unidades refugiadas.
	sheltered_label.text="Unidades Refugiadas:\n" + str(cave.sheltered_units) + "/12"
